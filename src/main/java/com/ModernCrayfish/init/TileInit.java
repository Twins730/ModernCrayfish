...
public class TileInit {
    ...
    public static final RegistryObject<TileEntityType<ToasterTileEntity>> TOASTER = TILE_ENTITIES.register("toaster",()-> TileEntityType.Builder.of(ToasterTileEntity::new,BlockInit.TOASTER.get()).build(null));
