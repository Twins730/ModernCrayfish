...
public class TileInit {
    ...
    public static final RegistryObject<TileEntityType<PlateTileEntity>> PLATE_TILE = TILE_ENTITIES.register("",()-> TileEntityType.Builder.of(PlateTileEntity::new,BlockInit.PLATE.get()).build(null));
