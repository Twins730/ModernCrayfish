...
public class CeilingFanTileEntityRenderer extends TileEntityRenderer<CeilingFanTileEntity> {
    ...
    public void render(CeilingFanTileEntity tileEntity, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_) {
        ...
        float rotation = tileEntity.prevFanRotation + (tileEntity.fanRotation - tileEntity.prevFanRotation) * Minecraft.getInstance().getRenderPartialTicks();
        p_225616_3_.rotate(Vector3f.YP.rotationDegrees(-rotation));
        Minecraft.getInstance().getItemRenderer().renderItem(new ItemStack(ItemInit.CEILING_FAN_FAN.get()), ItemCameraTransforms.TransformType.NONE,p_225616_5_,p_225616_6_,p_225616_3_,p_225616_4_);
        p_225616_3_.pop();
